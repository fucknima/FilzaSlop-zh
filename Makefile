...
FilzaApplySandboxExt_FILES = Tweak.m MCMBridge.m MCMFilzaIntegration.m PosterBoardFeature.m TGFocusedInputResponderTimingFix.m StartupProgressController.m ArchiveUnzipFix.m
